...
import { describe, expect, it, jest } from './test-deps.ts';
...
describe('Result', () => {
    ...
    describe('expectErr', () => {
        it('Returns the contained `Err` value, consuming the `self` value.', () => {
            ...
            expect(() => x2.expectErr('Testing expect_err')).toThrow('Testing expect_err: 10');
        });
    });
    ...
    describe('intoOk', () => {
        it('Throws an UnimplementedError because it is not yet supported.', () => {
            const x: Result<number, string> = Ok(2);
            expect(() => x.intoOk()).toThrow('Result.intoOk() is not implemented');
        });
    });
    ...
    describe('intoErr', () => {
        it('Throws an UnimplementedError because it is not yet supported.', () => {
            const x: Result<number, string> = Err('emergency failure');
            expect(() => x.intoErr()).toThrow('Result.intoErr() is not implemented');
        });
    });
